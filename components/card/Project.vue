  ...
  >
    <div class="z-10 relative w-full h-full">
      <img
        ...
        width="535"
        height="261"
        :src="`/api/screenshots/${encodeURIComponent(projectDetails.urlLink)}`"
      />
      <div
    ...
    >
      <div class="projectTextContainer subFontFamily">
        ...
        <div
          class="flex justify-between items-end max-h-9 space-x-5 rtl:space-x-reverse mt-8 md:mt-5 lg:mt-0"
        >
          ...
          <div class="flex items-center space-x-2 rtl:space-x-reverse pb-0.5">
            <a
            ...
            >
              <svg
                ...
                fill="currentColor"
                class="bi bi-arrow-up-right-square-fill rtl:-scale-x-100 w-5 h-5 hover:text-gray-600 rounded"
                viewBox="0 0 16 16"
              >
                <path
